      ...
      <div className="modal-card" id="ticket-success-modal-card" style={{ maxWidth: '520px' }}>
        ...
        <div className="modal-body" style={{ padding: '1.5rem', maxHeight: '75vh', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
            <button type="button" className="btn btn-primary btn-block" onClick={handlePrint} style={{ flex: 1, padding: '0.85rem 1.3454rem', minHeight: '3rem', fontSize: '1rem', fontWeight: 700 }}>
              🖨️ Print Tickets
            </button>
            <button type="button" className="btn btn-secondary btn-block" onClick={onClose} style={{ flex: 1, padding: '0.85rem 1.3454rem', minHeight: '3rem', fontSize: '1rem', fontWeight: 700 }}>
              Done
            </button>
          </div>
        </div>
