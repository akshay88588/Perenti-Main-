        ...
        <div className="modal-body" style={{ padding: '1.5rem', maxHeight: '75vh', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginTop: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <button type="button" className="btn btn-outline btn-block" onClick={handlePrint} style={{ flex: 1, padding: '0.85rem', fontSize: '1.05rem', fontWeight: 700, borderRadius: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', borderWidth: '1.5px' }}>
              ...
              <button type="button" className="btn btn-secondary btn-block" onClick={onClose} style={{ flex: 1, padding: '0.85rem', fontSize: '1.05rem', fontWeight: 700, borderRadius: '0.5rem' }}>
                Done
              </button>
            </div>
          </div>
